  ...
  <div class="phy-bat">
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button v-preventReClick type="primary" size="mini" @click="uploadData(0)">确 定</el-button>
  ...
  methods: {
    ...
    async uploadData(uploadtype) {
      ...
      try {
        ...
        if (uploadtype) {
          request.append('isNeedMd5ValidateFront', false)
        }
        // 调用接口,请求数据
        ...
        if (e.response.data.code === '041107017') {
          this.$confirm(e.response.data.msg, '提示', {
            cancelButtonText: '取消',
            type: 'warning'
          }).then(() => {
            this.uploadData(1)

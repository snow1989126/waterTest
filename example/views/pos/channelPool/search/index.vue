...
import { config } from '@base/module_pos/channel_pool_manage/search'
import { ExportExcel } from '@/axios/module_pos/channel_pool_manage/search'
import requestMixin from '@/axios/module_pos/channel_pool_manage/mixin'
export default {

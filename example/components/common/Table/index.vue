...
export default {
  ...
  methods: {
    ...
    arraySpanMethod({ row, column, rowIndex, columnIndex }) {
      ...
      } else if (this.Config.mergeTableColumnIndex.length === 2) {
      ...
      } else if (this.Config.mergeTableColumnIndex.length === 3) {
        if (columnIndex !== this.Config.mergeTableColumnIndex[0] && columnIndex !== this.Config.mergeTableColumnIndex[1] && columnIndex !== this.Config.mergeTableColumnIndex[2]) {
          if (row.nameIndex) {
            return [row.nameIndex, 1]
          } else return [0, 0]
        }
